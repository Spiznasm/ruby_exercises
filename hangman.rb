...
#For adding a display later
#@@body_parts = {"head"=>'O',"body"=>"|","l_arm"=>"/","r_arm"=>"\\","l_leg"=>"/","r_leg"=>"\\"}

#def drawing
#  puts "    ____\n   |   |\n   #{@@body_parts["head"]}   |\n  #{@@body_parts["l_arm"]}#{@@body_parts["body"]}#{@@body_parts["r_arm"]}  |\n  #{@@body_parts["l_leg"]}#{@@body_parts["r_leg"]}   |\n       |\n   ______"
#end
